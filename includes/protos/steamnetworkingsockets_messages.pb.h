...
template<> ::CMsgICERendezvous_Candidate* Arena::CreateMaybeMessage<::CMsgICERendezvous_Candidate>(Arena*);
...
class CMsgICERendezvous_Candidate PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CMsgICERendezvous.Candidate) */ {
 public:
  inline CMsgICERendezvous_Candidate() : CMsgICERendezvous_Candidate(nullptr) {}
  virtual ~CMsgICERendezvous_Candidate();
  explicit constexpr CMsgICERendezvous_Candidate(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(CMsgICERendezvous_Candidate* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(CMsgICERendezvous_Candidate* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline CMsgICERendezvous_Candidate* New() const final {
    return CreateMaybeMessage<CMsgICERendezvous_Candidate>(nullptr);
  }

  CMsgICERendezvous_Candidate* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CMsgICERendezvous_Candidate>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CMsgICERendezvous.Candidate";
  }
  protected:
  explicit CMsgICERendezvous_Candidate(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class CMsgICERendezvous PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  const ::CMsgICERendezvous_Candidate& _internal_add_candidate() const;
  ::CMsgICERendezvous_Candidate* _internal_mutable_add_candidate();
  public:
  void unsafe_arena_set_allocated_add_candidate(
      ::CMsgICERendezvous_Candidate* add_candidate);
  ::CMsgICERendezvous_Candidate* unsafe_arena_release_add_candidate();
...
// optional string candidate = 3;
inline bool CMsgICERendezvous_Candidate::_internal_has_candidate() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline const std::string& CMsgICERendezvous_Candidate::_internal_candidate() const {
  return candidate_.Get();
}
inline void CMsgICERendezvous_Candidate::_internal_set_candidate(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
...
inline std::string* CMsgICERendezvous_Candidate::_internal_mutable_candidate() {
  _has_bits_[0] |= 0x00000001u;
...
inline const ::CMsgICERendezvous_Candidate& CMsgICERendezvous::_internal_add_candidate() const {
  const ::CMsgICERendezvous_Candidate* p = add_candidate_;
  return p != nullptr ? *p : reinterpret_cast<const ::CMsgICERendezvous_Candidate&>(
      ::_CMsgICERendezvous_Candidate_default_instance_);
}
...
inline ::CMsgICERendezvous_Candidate* CMsgICERendezvous::unsafe_arena_release_add_candidate() {
...
inline ::CMsgICERendezvous_Candidate* CMsgICERendezvous::_internal_mutable_add_candidate() {
  _has_bits_[0] |= 0x00000001u;
  if (add_candidate_ == nullptr) {
    auto* p = CreateMaybeMessage<::CMsgICERendezvous_Candidate>(GetArena());
    add_candidate_ = p;
  }
