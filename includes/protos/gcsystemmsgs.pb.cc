...
static constexpr ::PROTOBUF_NAMESPACE_ID::Metadata* file_level_metadata_gcsystemmsgs_2eproto = nullptr;
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_gcsystemmsgs_2eproto[2];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_gcsystemmsgs_2eproto::offsets[1] = {};
...
const char descriptor_table_protodef_gcsystemmsgs_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "#\n\036k_EMsgGCServerConnectionStatus\020\252\037B\005H\001"
  "\200\001\000"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_gcsystemmsgs_2eproto = {
  false, false, 723, descriptor_table_protodef_gcsystemmsgs_2eproto, "gcsystemmsgs.proto", 
...
descriptor_table_gcsystemmsgs_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_gcsystemmsgs_2eproto);
  return descriptor_table_gcsystemmsgs_2eproto.file_level_metadata[index];
}
