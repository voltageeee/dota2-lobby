...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_dota_5fgcmessages_5fmsgid_2eproto_metadata_getter(int index);
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
constexpr EDOTAGCMsg EDOTAGCMsg_MAX = k_EMsgGCToServerScenarioSave;
