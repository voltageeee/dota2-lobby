...
constexpr EMsg EMsg_MIN = k_EMsgInvalid;
constexpr EMsg EMsg_MAX = k_EMsgBaseSecretServer;
...
constexpr EClientPersonaStateFlag EClientPersonaStateFlag_MIN = k_EClientPersonaStateFlagStatus;
...
constexpr EMsgClanAccountFlags EMsgClanAccountFlags_MIN = k_EMsgClanAccountFlagPublic;
...
constexpr ESteamReviewScore ESteamReviewScore_MIN = k_ESteamReviewScore_None;
